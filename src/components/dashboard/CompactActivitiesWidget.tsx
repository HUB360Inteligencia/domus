...
export function CompactActivitiesWidget() {
  ...
  if (isLoadingActivities) {
    return (
      <Card className="shadow-sm hover:shadow-md transition-shadow bg-white border-gray-200 h-64">
        <CardContent className="p-4">
          <div className="space-y-4">
            <h3 className="text-base font-semibold text-gray-900">Atividades</h3>
        ...
        <div className="flex items-center justify-between mb-4 flex-shrink-0">
          ...
          <div className="flex items-center space-x-2">
            <SimpleToggle 
              ...
              options={viewOptions}
              className="bg-gray-100 p-0.5 rounded-md h-8 text-xs"
            />
            <Button
              size="sm"
                ...
                >
                  <div className="flex items-center space-x-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="text-sm font-medium text-gray-900 truncate mb-1">{activity.title}</div>
